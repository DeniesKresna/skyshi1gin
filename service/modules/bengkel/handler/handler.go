...
import (
	...
	"github.com/DeniesKresna/bengkelgin/service/modules/bengkel/usecase"
...
type BengkelHandler struct {
	BengkelUsecase usecase.BengkelUsecase
}

func BengkelCreateHandler(bengkelUsecase usecase.BengkelUsecase) BengkelHandler {
